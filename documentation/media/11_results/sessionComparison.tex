...
\begin{tikzpicture}
	\pgfplotstableread[col sep=comma]{media/11_results/avgPowerVsDurationOpt.csv}\tableOpt
	\pgfplotstableread[col sep=comma]{media/11_results/avgPowerVsDurationDis.csv}\tableDis
	\begin{axis}[ylabel=Duration (Seconds), xlabel=Average Power (kWh), ymode=log]
		...
		\legend{Small-Gap Solution, Large-Gap Solution}
	\end{axis}
\end{tikzpicture}
