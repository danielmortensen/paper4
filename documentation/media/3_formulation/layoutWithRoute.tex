...
\centering
	\begin{tikzpicture}
		\node[rectangle, minimum width=5.8in, minimum height=0.5in](title) at (7.75, 7){\scalebox{2}{Bus n}};
		...
		\node[rectangle, fill=gray!10, minimum width=5.8in, minimum height=0.5in](bus3Box) at (7.75,5.5){};
		\node(bus1BoxLabel) at (-0.5, 5.5){Route};
		...
		\foreach \curLab/\preLab[count=\c, evaluate=\c as \pos using {0.5 + (\c - 1)*14.5/9}] in {t_1/t_1, t_2/t_1, t_3/t_2, t_4/t_3, t_5/t_4, t_6/t_7, t_7/t_6, t_8/t_7, t_9/t_8, t_{end}/t_9}
		{
			...
			\ifnum\c>1 
				...
				\draw[->, line width=0.5pt] (r1Prev.east) -- node[midway, above]{$r,\ \preLab$}(r1Curr.west);	
			\fi
				\node(b1Prev) at (\pos, 1   - 0.2){};
				\node(b2Prev) at (\pos, 2.5 - 0.2){};
				\node(b3Prev) at (\pos, 4   - 0.2){};	
				\node(r1Prev) at (\pos, 5.5 - 0.2){};
		}
	\end{tikzpicture}
	\caption{Description of bus information including routes}
	\label{fig:layoutWithRoute}
\end{figure*}
