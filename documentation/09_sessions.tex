...
%\end{aligned}
\end{equation}
where $a(i,r)$ and $d(i,r)$ are known from the previous optimization problem {\textbf [Name it]}, and $b(i,r)$ and $f(i,r)$ are optimization variables. 
