...
\begin{tikzpicture}
	\begin{axis}[SmallTimeSeriesPlot, xlabel=Time (hr:min), ylabel=#3, ymin = -10, ymax=2000, legend style={nodes={scale=0.7}}]
		\filldraw[fill=gray!40, opacity=0.3](625,0) rectangle (917,200);
...
\newcommand\makeComparisonPower[5]{%
	...
	\centering
	\begin{tikzpicture}
		\begin{axis}[SmallTimeSeriesPlot, ymin=-10, ymax=2000, xlabel=Time (hr:min), ylabel=#3, legend style={nodes={scale=0.5}}]
