function [Sol5, Var5] = computeReOptimizedSolution(Sim5, lossType)
...
if strcmp(lossType,"fiscal")
    model.obj = con4.getObj(Sim5, Var5);
elseif strcmp(lossType,"consumption")
    model.obj = con4.getObjConsumption(Sim5, Var5);
elseif strcmp(lossType,"baseline")
    model.Q = con4.getObjBaseline(Sim5, Var5);
else
